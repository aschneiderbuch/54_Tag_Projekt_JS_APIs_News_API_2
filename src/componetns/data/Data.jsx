...
// hier fetch machen 
// dann obj exportieren


// um Daten außerhalb des fetches zu speichern braucht man     useState
// damit der fetch evtl. keinen infinite loop :-( außlöst und alles abstürzt braucht man    useEffect
// -->  heißt, um den fetch wird    useEffect   herum gebaut

// Vorsicht    fetch ist async 
...
const dataExport = {
    ...
    "articles": [
        ...
        },
        {
            ...
            "title": "Mittwoch: Teslas Kryptoverluste & Bußgeldsenkung, AMDs Gewinne dank Serversparte",
            "description": "100 Dollar Verlust pro Tesla + AMD im Plus dank Epyc + Paypal streicht Stellen + Snapchat mit mehr Nutzern + Potsdam weiter offline + DSL-Beschleunigung mit 5G",
            "url": "https://www.heise.de/news/Mittwoch-Teslas-Kryptoverluste-Bussgeldsenkung-AMDs-Gewinne-dank-Serversparte-7477372.html",
            "urlToImage": "https://heise.cloudimg.io/bound/1200x1200/q85.png-lossy-85.webp-lossy-85.foil1/_www-heise-de_/imgs/18/3/6/8/9/2/7/7/mittwoch-c847c678f745e4d4.webp",
            "publishedAt": "2023-02-01T05:30:00Z",
            "content": "Über 100 US-Dollar pro verkauftem Auto. So hoch sind Teslas Spekulationsverluste mit Bitcoin 2022. Mit dem Umweltbundesamt konnte Tesla lukrativer verhandeln, denn nach Klage und Vergleich wurde das … [+4156 chars]"
        },
        {
            "source": {
                "id": null,
